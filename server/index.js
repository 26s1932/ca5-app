...
const connectString = `mongodb+srv://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@postitcluster.tjg0e.mongodb.net//${process.env.MONGO_DATABASE}?retryWrites=true&w=majority&appName=PostITCluster` 
